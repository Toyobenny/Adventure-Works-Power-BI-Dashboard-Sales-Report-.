...
![Dashboard Screenshot](AdventureWorks_Dashboard_Screenshot.png)
 ## Dashboard Overview
...
- **Filters**: Data Slicers and Business Type filter for interactive exploration.
  ...
  ## Key Insights
  - Bikes generate the highest revenue at $95M despite components dominating in volume.
  - Components Clothing and Accesories account for the remaining $14M combines
  - Average discount is 0.28%, indicating the business competes on product value rather than pricing.
